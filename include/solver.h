...
class cSolver {
 public:
  ...
  void calib(std::vector<data_selection::SyncData> &calib_data, int outliers_iterations, calib_result &res);
 ...
 public:
  ...
  void compute_disagreement(data_selection::SyncData &calib_data, const struct calib_result &res);
  void estimate_noise(std::vector<data_selection::SyncData> &calib_data, const struct calib_result &res, double &std_x,
                      double &std_y, double &std_th);
  double calculate_sd(const double array[], const int s, const int e);
  Eigen::MatrixXd compute_fim(const std::vector<data_selection::SyncData> &calib_data, const struct calib_result &res,
