...
class cSolver {
 public:
  ...
  bool solve(const std::vector<data_selection::sync_data> &calib_data, int mode, double max_cond_number,
 ...
 public:
  ...
  void estimate_noise(std::vector<data_selection::sync_data> &calib_data, const struct calib_result &res, double &std_x,
