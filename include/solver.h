...
class cSolver {
 public:
  ...
  bool solve(const std::vector<DataSelection::sync_data> &calib_data, int mode, double max_cond_number,
             struct calib_result &res);
  void calib(std::vector<DataSelection::sync_data> &calib_data, int outliers_iterations, calib_result &res);
 ...
 public:
  ...
  void compute_disagreement(DataSelection::sync_data &calib_data, const struct calib_result &res);
  void estimate_noise(std::vector<DataSelection::sync_data> &calib_data, const struct calib_result &res, double &std_x,
                      double &std_y, double &std_th);
  double calculate_sd(const double array[], const int s, const int e);
  Eigen::MatrixXd compute_fim(const std::vector<DataSelection::sync_data> &calib_data, const struct calib_result &res,
