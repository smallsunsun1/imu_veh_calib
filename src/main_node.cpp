...
DEFINE_string(odom_data, "/home/jiahesun/projects/imu_veh_calib/test_data/formatted_odometry.txt",
              "file where store the odom data");
DEFINE_string(cam_data, "/home/jiahesun/projects/imu_veh_calib/test_data/formatted_camera.txt",
              "file where store the imu data");
...
void CalcProcess(data_selection::OdomDataList& odom_datas, data_selection::CamDataList& cam_datas) {
  ...
  c_solve.Calib(sync_result, 4, paras);  // by svd
